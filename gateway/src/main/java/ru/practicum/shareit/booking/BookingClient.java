...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getBookerBookingsByState(long userId, State state, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> getOwnerBookingsByState(long userId, State state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
